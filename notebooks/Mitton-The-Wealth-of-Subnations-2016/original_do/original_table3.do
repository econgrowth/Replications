...
merge m:m isocode using "Replication/merge.dta"
drop _merge
sort isocode
save "Replication/merge.dta", replace
...
sort isocode
merge m:m isocode using "Ruggedness Data.dta"
drop _merge
gen cclat=cclatdeg+cclatmin/100+cclatsec/10000

sort isocode
merge m:m isocode using "malaria data.dta"
drop _merge

sort index
merge m:m index using "Ocean Access Data.dta"
drop _merge
