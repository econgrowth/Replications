...
sort isocode
merge isocode using "Ruggedness Data.dta"
drop _merge
gen cclat=cclatdeg+cclatmin/100+cclatsec/10000

sort isocode
merge isocode using "malaria data.dta"
drop _merge

sort index
merge index using "Ocean Access Data.dta"
drop _merge
...
sort isocode
merge isocode using "biomemerge.dta"
drop _merge
...
sort index
merge index using  "institutions concordance.dta"
...
sort index_afro
merge index_afro using "Replication/merge1.dta"
drop if _merge==2
drop _merge
save "Replication/merge2.dta", replace
...
use "Replication/merge2.dta", clear
sort index_taf
merge index_taf using "Replication/merge1.dta"
drop if _merge==2
drop _merge
save "Replication/merge2.dta", replace
...
use "Replication/merge2.dta", clear
sort index_qog
merge index_qog using "Replication/merge1.dta"
drop if _merge==2
drop _merge
save "Replication/merge2.dta", replace
...
use "Replication/merge2.dta", clear
sort index_wbes
merge index_wbes using "Replication/merge1.dta"
drop if _merge==2
drop _merge
save "Replication/merge2.dta", replace
...
use "Replication/merge2.dta", clear
sort index_db
merge index_db using "Replication/merge1.dta"
drop if _merge==2
drop _merge
save "Replication/merge2.dta", replace
...
use "Replication/merge2.dta", clear
sort index_lapop
merge index_lapop using "Replication/merge1.dta"
drop if _merge==2
drop _merge
save "Replication/merge2.dta", replace
...
use "Replication/merge2.dta", clear
sort index_lbo
merge index_lbo using "Replication/merge1.dta"
drop if _merge==2
drop _merge
save "Replication/merge2.dta", replace
...
sort index
merge index using  "national capitals.dta"
drop _merge
gen nlargestcity=0
replace nlargestcity=1 if ~(nationallargestcity=="")

sort index
merge index using "education from glls.dta"
drop _merge

sort index
merge index using "autonomy.dta"
gen autoregion=0
