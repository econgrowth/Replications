...
egen corruptionz=std(corruption)
egen stabilityz=std(stability)
egen regulatez=std(regulate)

gen instcombined=(ruleoflaw+corruption+stability+regulate)/4
egen instcombinedz=std(instcombined)
